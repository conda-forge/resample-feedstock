...
Home: https://github.com/resample-project/resample
...
Once the `conda-forge` channel has been enabled, `resample` can be installed with:

```
conda install resample
```

It is possible to list all of the versions of `resample` available on your platform with:
